...
echo_bold "==> Installing requirements for instance_occlsegm_lib"
...
# Install instance_occlsegm_lib
echo_bold "==> Installing instance_occlsegm_lib"
pip install -e .

set +e

echo_bold "\nAll is well! You can start using instance_occlsegm_lib!
